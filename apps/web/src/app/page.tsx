...
export default function Home() {
  return (
    <div className="dark h-screen overflow-y-scroll flex flex-col pt-40">
      ...
      <div className="flex flex-col items-center gap-6 px-4 md:px-10 pt-20 pb-20 bg-gradient-to-t from-zinc-800 from-0% via-black via-30% w-full border-b border-b-zinc-800">
        <div className="flex flex-col gap-10 text-2xl">
          <Button size="lg" variant="solid" className="text-white fill-zinc-50">
            Connect <RegularLinkedinOriginal className="text-lg " />
          </Button>

          <div className="fill-zinc-50 flex gap-4 items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto mt-10 px-4 md:px-10 flex flex-col text-center gap-10 items-center justify-center w-full">
